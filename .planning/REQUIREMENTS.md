...
- [x] **FOUND-02**: Light water fluid properties (ρ, cp, μ, k) as polynomial functions of T, registered via `@register_symbolic`, callable from any component without injection
