...
- [x] **DEBT-02**: THERM-03 test directly asserts ChannelAndContacts behavioral output rather than validating via a proxy
...
- [x] **CHAN-03**: User can connect only one side of ChannelAndContacts and the unconnected side defaults to adiabatic (Q_flow=0 verified by explicit test)
